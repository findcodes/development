...
<!-- Mirrored from construction.framework-y.com/index.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 02 Jun 2016 16:47:48 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <script src="<?php echo base_url();?>assets/plugins/jquery.min.2.1.4.js"></script>
    <link rel="stylesheet" href="<?php echo base_url();?>assets/plugins/bootstrap/css/bootstrap.css">
    <script src="<?php echo base_url();?>assets/script.js"></script>
    <script src="<?php echo base_url();?>assets/plugins/parallax.min.js"></script>
    ...
    <link rel="stylesheet" href='<?php echo base_url();?>assets/plugins/php/contact-form.css'>
    <link rel="stylesheet" href='<?php echo base_url();?>assets/plugins/flexslider/flexslider.css'>
    <link rel='stylesheet' href='<?php echo base_url();?>assets/plugins/magnific-popup.css'>
...
<body>
            ...
            <div class="navbar-mini scroll-hide scroll-show-mobile">
                <div class="container">
                    <div class="nav navbar-nav navbar-left">
                        ...
                        <hr />
                        <span><i class="fa fa-envelope-o"></i>info@construction.com</span>
                    </div>
                    <div class="nav navbar-nav navbar-right">
                        <ul class="nav navbar-nav over lan-menu">
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">
                                    <img src="<?php echo base_url();?>assets/images/en.png" alt="flag" />EN <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a href="#"><img src="<?php echo base_url();?>assets/images/it.png" alt="flag" />IT</a></li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" data-menu-anima="fade-bottom">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">Company <i class="caret"></i></a>
                                <ul class="dropdown-menu multi-level">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu multi-level">
                                    ...
                                    <li><a href="service-single-1.html">Services single</a></li>
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">Projects<i class="caret"></i></a>
                                <ul class="dropdown-menu multi-level">
                                    <li class="dropdown dropdown-submenu">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Portfolio 1</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="portfolio-1-gutted-boxed.html">Gutted boxed</a></li>
                                            <li><a href="portfolio-1-gutted-full-width.html">Gutted full width</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown dropdown-submenu">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Portfolio 2</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="portfolio-2-full-width.html">Full width</a></li>
                                            <li><a href="portfolio-2-boxed.html">Boxed</a></li>
                                            <li><a href="portfolio-2-gutted-boxed.html">Gutted boxed</a></li>
                                            <li><a href="portfolio-2-gutted-full-width.html">Gutted full width</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown dropdown-submenu">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Portfolio 3</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="portfolio-3-full-width.html">Full width</a></li>
                                            <li><a href="portfolio-3-boxed.html">Boxed</a></li>
                                            <li><a href="portfolio-3-gutted-boxed.html">Gutted boxed</a></li>
                                            <li><a href="portfolio-3-gutted-full-width.html">Gutted full width</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown dropdown-submenu">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Portfolio single</a>
                                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">Blog<i class="caret"></i></a>
                                <ul class="dropdown-menu multi-level">
                                    <li class="dropdown dropdown-submenu">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog archive</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="blog-1.html">Blog archive 1</a></li>
                                            <li><a href="blog-2.html">Blog archive 2</a></li>
                                            <li><a href="blog-3.html">Blog archive 3</a></li>
                                            <li><a href="blog-grid.html">Blog grid</a></li>
                                            <li><a href="blog-masonry.html">Blog masonry</a></li>
                                            <li><a href="blog-social.html">Blog social</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown dropdown-submenu">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog single</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="blog-single-1.html">Blog single 1</a></li>
                                            <li><a href="blog-single-2.html">Blog single 2</a></li>
                                            <li><a href="blog-single-3.html">Blog single 3</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">Contacts <i class="caret"></i></a>
                                <ul class="dropdown-menu multi-level">
                                    <li><a href="contacts-1.html">Contacts 1</a></li>
                                    <li><a href="contacts-2.html">Contacts 2</a></li>
                                    <li><a href="contacts-3.html">Contacts 3</a></li>
                                </ul>
                            </li>
                        </ul>
                        <div class="nav navbar-nav  navbar-right">
                        ...
                        <div class="col-md-3">
                            <div class="icon-box">
                                <div class="icon-box-cell">
                                    ...
                                    <label class="text-m">+02 1-700-568852</label>
                        ...
                        <div class="col-md-3">
                            <div class="icon-box">
                                <div class="icon-box-cell">
                                    ...
                                    <label class="text-m">info@billiobiz.com</label>
                                    <p class="text-xs">Write To Us</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <a class="btn btn-sm  btn-default" href="contacts-1.html" data-anima="pulse-vertical" data-trigger="hover">REQUEST A QUOTE</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="footer-parallax-container">
        <div class="section-bg-animation header-animation box-middle-container ken-burn ken-burn-center home-slider" data-natural-height="744" data-natural-width="1900" data-parallax="scroll" data-image-src="<?php echo base_url();?>assets/images/title-12.jpg">
            ...
            <div class="container content overlay-content text-center" data-anima="fade-top" data-timeline="asc" data-time="600" data-timeline-time="500">
                <div class="box-middle">
                    <h1 class="anima">WE ARE CONSTRUCTION</h1>
                    <hr class="space s" />
                    <img class="anima anima-fade-right" src="<?php echo base_url();?>assets/images/line-dx.png" alt="" />
                    <hr class="space s" />
                    <p class="anima text-bold-600">
                        We are expert in construction and building by 1980. We provide<br /> the best financing solution  for your business.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="row" data-anima="fade-bottom" data-timeline="asc">
                    <div class="col-md-4 anima">
                        <div class="advs-box advs-box-side" data-anima="fade-left" data-trigger="hover">
                            <div class="row">
                                <div class="col-md-3">
                                    <i class="anima icon onlycover text-l" style="background-image:url(<?php echo base_url();?>assets/images/icons/yellow/icon-31.png)"></i>
                                </div>
                                <div class="col-md-9">
                                    <h3>BUILDING AND DESIGN</h3>
                                    <hr class="anima">
                                    <p>
                    ...
                    <div class="col-md-4 anima">
                        <div class="advs-box advs-box-side" data-anima="fade-left" data-trigger="hover">
                            <div class="row">
                                <div class="col-md-3">
                                    <i class="anima icon onlycover text-l" style="background-image:url(<?php echo base_url();?>assets/images/icons/yellow/icon-39.png)"></i>
                                </div>
                                <div class="col-md-9">
                    ...
                    <div class="col-md-4 anima">
                        <div class="advs-box advs-box-side" data-anima="fade-left" data-trigger="hover">
                            <div class="row">
                                <div class="col-md-3">
                                    <i class="anima icon onlycover text-l" style="background-image:url(<?php echo base_url();?>assets/images/icons/yellow/icon-26.png)"></i>
                                </div>
                                <div class="col-md-9">
                                    <h3>OUTDOOR AND INDOOR</h3>
                                    <hr class="anima">
                                    <p>
                                        L'orem ipsum dolor "sitamet", consectetur 'adipisicing' elit, sed do eiusmod tempor incididunt
                                        ut labore et dolore magna aliqua. Ut enim ad minim veniam, q rem aperiam ...
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p>
                            ...
                            Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur, in culpa qui officia deserunt mollit anim, exercitation ullamco laboris nisi ut aliquip
                            Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum minim veniam, quis nostrud exercitation.
                        </p>
                    </div>
                    <div class="col-md-6" data-anima="show-scale" data-timeline="asc">
                        <img class="map-item anima" style="margin: 15px 0 0 15px;" src="<?php echo base_url();?>assets/images/map-point.png" data-toggle="tooltip" data-placement="top" title="Toronto, Canada" alt="" />
                        <img class="map-item anima" style="margin: 65px 0 0 250px;" src="<?php echo base_url();?>assets/images/map-point.png" data-toggle="tooltip" data-placement="top" title="Europe, Italy" alt="" />
                        <img class="map-item anima" style="margin: 35px 0 0 95px;" src="<?php echo base_url();?>assets/images/map-point.png" data-toggle="tooltip" data-placement="top" title="Washington, United States" alt="" />
                        <img class="map-item anima" style="margin: 85px 0 0 55px;" src="<?php echo base_url();?>assets/images/map-point.png" data-toggle="tooltip" data-placement="top" title="Miami, United States" alt="" />
                        <img class="map-item anima" style="margin: 35px 0 0 295px;" src="<?php echo base_url();?>assets/images/map-point.png" data-toggle="tooltip" data-placement="top" title="Moscow, Russian Federatin" alt="" />
                        <img class="map-item anima" style="margin: 125px 0 0 255px;" src="<?php echo base_url();?>assets/images/map-point.png" data-toggle="tooltip" data-placement="top" title="Kenya, Africa" alt="" />
                        <img class="map-item anima" style="margin: 105px 0 0 400px;" src="<?php echo base_url();?>assets/images/map-point.png" data-toggle="tooltip" data-placement="top" title="Bangkok, Asia" alt="" />
                        <img src="<?php echo base_url();?>assets/images/map-2.png" alt="" />
                    </div>
                </div>
        ...
        <div class="section-empty">
            <div class="container content">
                <div class="row">
                    <div class="col-md-6">
                        <form action="http://construction.framework-y.com/plugins/php/contact-form.php" class="form-box form-ajax" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <p>Name</p>
                    ...
                    <div class="col-md-6">
                        ...
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                            Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit  sed do eiusmod tempor incididunt ut labore  anim id est.
                            Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                        </p>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="icon-box">
                                    ...
                                    </div><div class="icon-box-cell"><label>Open Mon-Fri 8AM-5PM</label></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="icon-box">
                                    ...
                                    </div><div class="icon-box-cell"><label>(356) 89955310</label></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <hr />
                <hr class="space" />
                <div class="flexslider carousel" data-options="numItems:3,itemMargin:10,minWidth:250,directionNav:false">
                    <ul class="slides">
                        <li>
                            <div class="advs-box advs-box-top-icon boxed" data-anima="rotate-20" data-trigger="hover">
                                ...
                                <a class="anima-button circle-button btn-sm" href="#"><i class="fa fa-long-arrow-right"></i>More informations </a>
                            </div>
                        </li>
                        <li>
                            <div class="advs-box advs-box-top-icon boxed" data-anima="rotate-20" data-trigger="hover">
                                <i class="fa fa-building icon circle anima"></i>
                                <h4>CONSTRUCTION CONSULTAN</h4>
                                <p>
                                    L'orem ipsum dolor sitamet, consectetur adipisicing elit, sed do eiusmod tempor incididunt
                                    ut labore et dolore magna aliqua ...
                                </p>
        ...
        <div class="section-bg-video box-middle-container">
            <div class="videobox">
                <video autoplay loop muted poster="images/video-bg-2-poster.jpg">
                    <source src="<?php echo base_url();?>assets/images/video-bg-2.mp4" type="video/mp4">
                </video>
            </div>
            <div class="container content overlay-content box-middle white text-center">
                ...
                <p>
                    L'orem ipsum dolor, consectetur adipisicing elit sed do eiusmod tempor incididunt ut labore et dolorez
                    magna aliqua.Ut enim ad minim veniam, quis nostrud exercitation<br> ullamco laboris. Lorem ipsum dolor sit amet, consectetur adipiscing
                    elit, sed do eiusmod tempor incididunt ut labore<br> et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.
                </p>
                <hr class="space" />
        ...
        <a class="popup-trigger" data-trigger="scroll" href="#popup-1"></a>
        <div class="section-bg-color">
            <div class="container content">
                <div class="title-base title-small text-left" data-anima="show-scale" data-trigger="hover">
                    <h2>LATEST NEWS</h2>
                ...
                <div class="row" data-anima="fade-bottom">
                        ...
                        <div class="advs-box advs-box-top-icon-img niche-box-post boxed-inverse" data-anima="scale-rotate" data-trigger="hover">
                            <div class="block-infos">
                                <div class="block-data">
                                    <p class="bd-day">25</p>
                                    <p class="bd-month">July 2016</p>
                                </div>
                                <a class="block-comment" href="#">2 <i class="fa fa-comment-o"></i></a>
                            </div>
                            <a class="img-box grayscale"><img class="anima" src="images/news-1.jpg" alt="" /></a>
                            <div class="advs-box-content">
                                <h2><a href="blog-single-1.html">TEXAS IS HIRING CUNSTRUCTION EXPERTS</a></h2>
                                <div class="tag-row">
                                    <span><i class="fa fa-bookmark"></i> <a href="#">Construction</a></span>
                    ...
                    <div class="col-md-3">
                        <div class="advs-box advs-box-top-icon-img niche-box-post boxed-inverse" data-anima="scale-rotate" data-trigger="hover">
                            <div class="block-infos">
                                ...
                                <a class="block-comment" href="#">12 <i class="fa fa-comment-o"></i></a>
                            </div>
                            <a class="img-box grayscale"><img class="anima" src="images/news-2.jpg" alt="" /></a>
                            <div class="advs-box-content">
                                <h2><a href="blog-single-1.html">SMART ECO-HOUSE 2.0</a></h2>
                                <div class="tag-row">
                                    <span><i class="fa fa-bookmark"></i> <a href="#">Renovation</a></span>
                                    <div class="social-group-button social-line">
                                        <div class="social-button" data-anima="pulse-vertical" data-trigger="hover">
                                            <i class="fa fa-share-alt"></i>
                                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="advs-box advs-box-top-icon-img niche-box-post boxed-inverse" data-anima="scale-rotate" data-trigger="hover">
                            ...
                            <a class="img-box grayscale"><img class="anima" src="images/news-3.jpg" alt="" /></a>
                            <div class="advs-box-content">
                                <h2><a href="blog-single-1.html">BUY NOW TWO TOOLS AND GET ONE FREE</a></h2>
                                <div class="tag-row">
                                    <span><i class="fa fa-bookmark"></i> <a href="#">Building</a></span>
                                    <div class="social-group-button social-line">
                                        <div class="social-button" data-anima="pulse-vertical" data-trigger="hover">
                                            <i class="fa fa-share-alt"></i>
                                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="advs-box advs-box-top-icon-img niche-box-post boxed-inverse" data-anima="scale-rotate" data-trigger="hover">
                            <div class="block-infos">
                                <div class="block-data">
                                    <p class="bd-day">12</p>
                                    <p class="bd-month">May 2016</p>
                                </div>
                                <a class="block-comment" href="#">2 <i class="fa fa-comment-o"></i></a>
                            </div>
                            <a class="img-box grayscale"><img class="anima" src="images/news-4.jpg" alt="" /></a>
                            <div class="advs-box-content">
                                <h2><a href="blog-single-1.html">NEW MACHINES BUILD 5X FASTER</a></h2>
                                <div class="tag-row">
                                    <span><i class="fa fa-bookmark"></i> <a href="#">Construction</a></span>
                                    <div class="social-group-button social-line">
                                        <div class="social-button" data-anima="pulse-vertical" data-trigger="hover">
                ...
                <div class="row" data-anima="fade-bottom">
                    <div class="col-md-2">
                        <div class="icon-box icon-box-top-bottom">
                            <div class="icon-box-cell">
                                <b><label class="counter text-l" data-speed="2000" data-to="253"></label></b>
                                <p class="text-s">QUALIFIED WORKERS</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="icon-box icon-box-top-bottom">
                            <div class="icon-box-cell">
                                <b><label class="counter text-l" data-speed="2000" data-to="65"></label></b>
                                <p class="text-s">FANTASTIC CLIENTS</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="icon-box icon-box-top-bottom">
                            <div class="icon-box-cell">
                                <b><label class="counter text-l" data-speed="6000" data-to="150"></label></b>
                                <p class="text-s">WORKS COMPLETED</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="icon-box icon-box-top-bottom">
                            <div class="icon-box-cell">
                                <b><label class="counter text-l" data-speed="10000" data-to="850034"></label></b>
                                <p class="text-s">KG OF CEMENT</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="icon-box icon-box-top-bottom">
                            <div class="icon-box-cell">
                                <b><label class="counter text-l" data-speed="6000" data-to="250"></label></b>
                                <p class="text-s">HOUSE COMPLETED</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="icon-box icon-box-top-bottom">
                            <div class="icon-box-cell">
                                <b><label class="counter text-l" data-speed="6000" data-to="90"></label></b>
                                <p class="text-s">OUTDOOR WORKS</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="popup-1" class="popup-banner popup-bottom-right white" data-popup-anima="fade-right">
            ...
            <div class="bs-panel panel-default">
                <div class="panel-body">
                    <b class="text-uppercase text-bold">Hot pages</b>
                    <hr class="space xs" />
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="fa-ul text-xs">
                                <li><i class="fa-li fa fa-long-arrow-right"></i> <a href="services-1.html">Service 1</a></li>
                                <li><i class="fa-li fa fa-long-arrow-right"></i> <a href="careers.html">Careers</a></li>
                               
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <ul class="fa-ul text-xs">
                                <li><i class="fa-li fa fa-long-arrow-right"></i> <a href="services-3.html">Service 3</a></li>
                                <li><i class="fa-li fa fa-long-arrow-right"></i> <a href="contacts-1.html">Contacts 1</a></li>
                            </ul>
                        </div>
                    </div>      
                </div>
    ...
    <footer class="white footer-parallax">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 footer-left">
                        ...
                        <hr class="space s" />
                        <p>
                            Construction SRL works as international construction services company and is a leading builder in diverse and numerous market segments.
                    ...
                    <div class="col-md-4 footer-left">
                        ...
                        <ul class="fa-ul text-s">
                            ...
                            <li><i class="fa-li fa fa-envelope"></i> info@construction.com</li>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <ul class="fa-ul text-s">
                                    <li><i class="fa-li fa fa-angle-double-right"></i> <a href="#">Faq</a></li>
                                    <li><i class="fa-li fa fa-angle-double-right"></i> <a href="#">Manuals</a></li>
                                    <li><i class="fa-li fa fa-angle-double-right"></i> <a href="#">Company History</a></li>
                                    <li><i class="fa-li fa fa-angle-double-right"></i> <a href="#">Locations</a></li>
                                    <li><i class="fa-li fa fa-angle-double-right"></i> <a href="#">Privacy</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="copy-row">
            <div class="copy-text">
                ALL RIGHT RESERVED | FRAMEWORK Y | ENVATO
            </div>
        </div>

        <link property="" rel="stylesheet" href="<?php echo base_url();?>assets/plugins/font-awesome/css/font-awesome.min.css">
        <script type="text/javascript" async src="<?php echo base_url();?>assets/plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="<?php echo base_url();?>assets/plugins/imagesloaded.min.js"></script>
        <script src='<?php echo base_url();?>assets/plugins/flexslider/jquery.flexslider-min.js'></script>
        <script async src='<?php echo base_url();?>assets/plugins/jquery.progress-counter.js'></script>
        <script async src='<?php echo base_url();?>assets/plugins/jquery.tab-accordion.js'></script>
        <script async src="<?php echo base_url();?>assets/plugins/bootstrap/js/bootstrap.popover.min.js"></script>
        <script src='<?php echo base_url();?>assets/plugins/jquery.spritely.min.js'></script>
        <script src='<?php echo base_url();?>assets/plugins/php/contact-form.js'></script>
        <script src='<?php echo base_url();?>assets/plugins/jquery.magnific-popup.min.js'></script>
    </footer>
</body>

<!-- Mirrored from construction.framework-y.com/index.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 02 Jun 2016 16:50:07 GMT -->
</html>
